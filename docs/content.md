...
- Applied data-centric AI and conformal prediction methods to improve model reliability
- Led development of SLAM and multi-object tracking systems
- Established SOPs and process standards across a 50-person department, improving development culture and compliance
- Designed test strategies and built simulation environments (UNREAL Engine) for system validation

### Picidata, Guangzhou
**Project Manager** (2016 – 2018)

- Led a team of 5 data analysts delivering customized business solutions using data mining
